...
export const CURATED_FSQ_DESTINATION_PLACES: Record<string, FSQPlace[]> = {
  ...
  santorini: [
    {
      fsq_id: 'fsq_santo_att_01',
      name: 'Oia Sunset Lookout & Castle',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 16000, name: 'Landmark' }],
      geocodes: { main: { latitude: 36.4618, longitude: 25.3753 } },
      location: { formatted_address: 'Oia Village, Santorini 84702, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.8,
      price: 1,
    },
    {
      fsq_id: 'fsq_santo_att_02',
      name: 'Amoudi Bay',
      categories: [{ id: 16003, name: 'Beach' }, { id: 13065, name: 'Restaurant' }],
      geocodes: { main: { latitude: 36.4623, longitude: 25.3705 } },
      location: { formatted_address: 'Amoudi Bay, Oia, Santorini 84702, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.6,
      price: 3,
    },
    {
      fsq_id: 'fsq_santo_beach_01',
      name: 'Red Beach (Kokkini Paralia)',
      categories: [{ id: 16003, name: 'Beach' }],
      geocodes: { main: { latitude: 36.3486, longitude: 25.3948 } },
      location: { formatted_address: 'Akrotiri, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.3,
      price: 1,
    },
    {
      fsq_id: 'fsq_santo_beach_02',
      name: 'Perissa Black Sand Beach',
      categories: [{ id: 16003, name: 'Beach' }, { id: 13003, name: 'Bar' }],
      geocodes: { main: { latitude: 36.3556, longitude: 25.4744 } },
      location: { formatted_address: 'Perissa, Santorini 84703, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.4,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_beach_03',
      name: 'Kamari Beach Promenade',
      categories: [{ id: 16003, name: 'Beach' }, { id: 13034, name: 'Café' }],
      geocodes: { main: { latitude: 36.3778, longitude: 25.4853 } },
      location: { formatted_address: 'Kamari, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.2,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_hist_01',
      name: 'Akrotiri Archaeological Site',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 10027, name: 'Museum' }],
      geocodes: { main: { latitude: 36.3514, longitude: 25.4033 } },
      location: { formatted_address: 'Akrotiri, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.7,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_bar_01',
      name: 'Santo Wines Winery & Sunset Terrace',
      categories: [{ id: 13025, name: 'Wine Bar' }, { id: 13003, name: 'Bar' }],
      geocodes: { main: { latitude: 36.3861, longitude: 25.4328 } },
      location: { formatted_address: 'Pyrgos Kallistis, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.6,
      price: 3,
    },
    {
      fsq_id: 'fsq_santo_att_03',
      name: 'Fira Old Port & Cable Car',
      categories: [{ id: 16000, name: 'Landmark' }, { id: 10000, name: 'Entertainment' }],
      geocodes: { main: { latitude: 36.4194, longitude: 25.4289 } },
      location: { formatted_address: 'Fira, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.1,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_hist_02',
      name: 'Skaros Rock Ruins',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 16024, name: 'Fort' }],
      geocodes: { main: { latitude: 36.4328, longitude: 25.4194 } },
      location: { formatted_address: 'Imerovigli, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.5,
      price: 1,
    },
    {
      fsq_id: 'fsq_santo_hist_03',
      name: 'Pyrgos Medieval Village',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 16021, name: 'Heritage' }],
      geocodes: { main: { latitude: 36.3831, longitude: 25.4503 } },
      location: { formatted_address: 'Pyrgos Kallistis, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.3,
      price: 1,
    },
    {
      fsq_id: 'fsq_santo_rest_01',
      name: 'Melitini Greek Meze',
      categories: [{ id: 13065, name: 'Restaurant' }],
      geocodes: { main: { latitude: 36.4628, longitude: 25.3789 } },
      location: { formatted_address: 'Oia, Santorini 84702, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.4,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_cafe_01',
      name: 'Pelican Kipos Cafe & Garden',
      categories: [{ id: 13034, name: 'Café' }, { id: 13035, name: 'Coffee Shop' }],
      geocodes: { main: { latitude: 36.4172, longitude: 25.4317 } },
      location: { formatted_address: 'Main Square, Fira, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.2,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_cafe_02',
      name: 'Lotza Cafe Oia',
      categories: [{ id: 13034, name: 'Café' }],
      geocodes: { main: { latitude: 36.4633, longitude: 25.3761 } },
      location: { formatted_address: 'Nik. Nomikou, Oia, Santorini 84702, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.1,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_bar_02',
      name: 'Franco’s Bar Thira',
      categories: [{ id: 13006, name: 'Cocktail Bar' }, { id: 13003, name: 'Bar' }],
      geocodes: { main: { latitude: 36.4167, longitude: 25.4308 } },
      location: { formatted_address: 'Fira Caldera, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.5,
      price: 3,
    },
    {
      fsq_id: 'fsq_santo_bar_03',
      name: 'PK Cocktail Bar Fira',
      categories: [{ id: 13006, name: 'Cocktail Bar' }, { id: 13003, name: 'Bar' }],
      geocodes: { main: { latitude: 36.4181, longitude: 25.4303 } },
      location: { formatted_address: 'Theotokopoulou Square, Fira, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.6,
      price: 3,
    },
    {
      fsq_id: 'fsq_santo_mus_01',
      name: 'Museum of Prehistoric Thira',
      categories: [{ id: 10027, name: 'Museum' }, { id: 10030, name: 'History Museum' }],
      geocodes: { main: { latitude: 36.4161, longitude: 25.4325 } },
      location: { formatted_address: 'Mitropoleos, Fira, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.2,
      price: 1,
    },
    {
      fsq_id: 'fsq_santo_beach_04',
      name: 'White Beach (Lefki Paralia)',
      categories: [{ id: 16003, name: 'Beach' }],
      geocodes: { main: { latitude: 36.3469, longitude: 25.3889 } },
      location: { formatted_address: 'Akrotiri Coast, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.0,
      price: 1,
    },
    {
      fsq_id: 'fsq_santo_rest_02',
      name: 'Metaxy Mas Traditional Tavern',
      categories: [{ id: 13065, name: 'Restaurant' }],
      geocodes: { main: { latitude: 36.3878, longitude: 25.4578 } },
      location: { formatted_address: 'Exo Gonia, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.6,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_cafe_03',
      name: 'Passaggio Oia Cafe & Bites',
      categories: [{ id: 13034, name: 'Café' }, { id: 13002, name: 'Bakery' }],
      geocodes: { main: { latitude: 36.4639, longitude: 25.3769 } },
      location: { formatted_address: 'Oia Pedestrian Walkway, Santorini 84702, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.0,
      price: 2,
    },
    {
      fsq_id: 'fsq_santo_bar_04',
      name: 'Tango Bar Caldera',
      categories: [{ id: 10039, name: 'Night Club' }, { id: 13003, name: 'Bar' }],
      geocodes: { main: { latitude: 36.4178, longitude: 25.4300 } },
      location: { formatted_address: 'Marinatou, Fira, Santorini 84700, Greece', country: 'GR', locality: 'Santorini' },
      rating: 9.3,
      price: 3,
    },
  ],
  bali: [
    {
      fsq_id: 'fsq_bali_beach_01',
      name: 'Kuta Beach',
      categories: [{ id: 16003, name: 'Beach' }, { id: 18000, name: 'Adventure' }],
      geocodes: { main: { latitude: -8.7185, longitude: 115.1686 } },
      location: { formatted_address: 'Pantai Kuta, Badung, Bali 80361, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.1,
      price: 1,
    },
    {
      fsq_id: 'fsq_bali_beach_02',
      name: 'Seminyak Beach & Sunset Strip',
      categories: [{ id: 16003, name: 'Beach' }, { id: 13003, name: 'Bar' }],
      geocodes: { main: { latitude: -8.6913, longitude: 115.1539 } },
      location: { formatted_address: 'Seminyak, Kuta, Badung, Bali 80361, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.4,
      price: 2,
    },
    {
      fsq_id: 'fsq_bali_hist_01',
      name: 'Uluwatu Temple & Kecak Dance',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 12099, name: 'Temple' }],
      geocodes: { main: { latitude: -8.8291, longitude: 115.0849 } },
      location: { formatted_address: 'Pecatu, South Kuta, Badung, Bali 80361, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.7,
      price: 2,
    },
    {
      fsq_id: 'fsq_bali_hist_02',
      name: 'Tanah Lot Sea Temple',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 12099, name: 'Temple' }],
      geocodes: { main: { latitude: -8.6212, longitude: 115.0868 } },
      location: { formatted_address: 'Beraban, Kediri, Tabanan, Bali 82121, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.6,
      price: 2,
    },
    {
      fsq_id: 'fsq_bali_nat_01',
      name: 'Sacred Monkey Forest Sanctuary',
      categories: [{ id: 16032, name: 'Park' }, { id: 16000, name: 'Landmark' }],
      geocodes: { main: { latitude: -8.5188, longitude: 115.2582 } },
      location: { formatted_address: 'Jl. Monkey Forest, Ubud, Gianyar, Bali 80571, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.5,
      price: 2,
    },
    {
      fsq_id: 'fsq_bali_nat_02',
      name: 'Tegallalang Rice Terraces',
      categories: [{ id: 16032, name: 'Park' }, { id: 16043, name: 'Photography' }],
      geocodes: { main: { latitude: -8.4331, longitude: 115.2785 } },
      location: { formatted_address: 'Jl. Raya Tegallalang, Gianyar, Bali 80561, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.6,
      price: 1,
    },
    {
      fsq_id: 'fsq_bali_bar_01',
      name: 'Potato Head Beach Club',
      categories: [{ id: 13003, name: 'Bar' }, { id: 10039, name: 'Night Club' }],
      geocodes: { main: { latitude: -8.6796, longitude: 115.1481 } },
      location: { formatted_address: 'Jl. Petitenget No.51B, Seminyak, Bali 80361, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.5,
      price: 3,
    },
    {
      fsq_id: 'fsq_bali_bar_02',
      name: 'Finns Beach Club Canggu',
      categories: [{ id: 13003, name: 'Bar' }, { id: 10039, name: 'Night Club' }, { id: 16003, name: 'Beach' }],
      geocodes: { main: { latitude: -8.6653, longitude: 115.1378 } },
      location: { formatted_address: 'Jl. Pantai Berawa No.99, Canggu, Bali 80361, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.4,
      price: 3,
    },
    {
      fsq_id: 'fsq_bali_cafe_01',
      name: 'Revolver Espresso Seminyak',
      categories: [{ id: 13035, name: 'Coffee Shop' }, { id: 13034, name: 'Café' }],
      geocodes: { main: { latitude: -8.6868, longitude: 115.1582 } },
      location: { formatted_address: 'Jl. Kayu Aya No.Gang 51, Seminyak, Bali 80361, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.3,
      price: 2,
    },
    {
      fsq_id: 'fsq_bali_cafe_02',
      name: 'Seniman Coffee Studio Ubud',
      categories: [{ id: 13035, name: 'Coffee Shop' }, { id: 13034, name: 'Café' }],
      geocodes: { main: { latitude: -8.5049, longitude: 115.2638 } },
      location: { formatted_address: 'Jl. Sri Wedari No.5, Ubud, Gianyar, Bali 80571, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.4,
      price: 2,
    },
    {
      fsq_id: 'fsq_bali_rest_01',
      name: 'Locavore Restaurant Ubud',
      categories: [{ id: 13065, name: 'Restaurant' }],
      geocodes: { main: { latitude: -8.5097, longitude: 115.2662 } },
      location: { formatted_address: 'Jl. Dewisita No.10, Ubud, Gianyar, Bali 80571, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.7,
      price: 4,
    },
    {
      fsq_id: 'fsq_bali_mkt_01',
      name: 'Ubud Traditional Art Market',
      categories: [{ id: 17069, name: 'Market' }, { id: 17000, name: 'Shopping' }],
      geocodes: { main: { latitude: -8.5068, longitude: 115.2625 } },
      location: { formatted_address: 'Jl. Raya Ubud No.35, Ubud, Gianyar, Bali 80571, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.1,
      price: 1,
    },
    {
      fsq_id: 'fsq_bali_beach_03',
      name: 'Padang Padang Beach',
      categories: [{ id: 16003, name: 'Beach' }],
      geocodes: { main: { latitude: -8.8111, longitude: 115.1039 } },
      location: { formatted_address: 'Pecatu, South Kuta, Badung, Bali 80361, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.3,
      price: 1,
    },
    {
      fsq_id: 'fsq_bali_bar_03',
      name: 'Single Fin Uluwatu',
      categories: [{ id: 13003, name: 'Bar' }, { id: 13006, name: 'Cocktail Bar' }],
      geocodes: { main: { latitude: -8.8149, longitude: 115.0883 } },
      location: { formatted_address: 'Pantai Suluban, Uluwatu, Bali 80361, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.3,
      price: 2,
    },
    {
      fsq_id: 'fsq_bali_hist_03',
      name: 'Tirta Empul Holy Water Temple',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 12099, name: 'Temple' }],
      geocodes: { main: { latitude: -8.4153, longitude: 115.3150 } },
      location: { formatted_address: 'Manukaya, Tampaksiring, Gianyar, Bali 80552, Indonesia', country: 'ID', locality: 'Bali' },
      rating: 9.5,
      price: 2,
    },
  ],
  tokyo: [
    {
      fsq_id: 'fsq_tokyo_mon_01',
      name: 'Shibuya Crossing & Hachiko Statue',
      categories: [{ id: 16026, name: 'Monument' }, { id: 16000, name: 'Landmark' }],
      geocodes: { main: { latitude: 35.6595, longitude: 139.7005 } },
      location: { formatted_address: 'Dogenzaka, Shibuya, Tokyo 150-0043, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.7,
      price: 1,
    },
    {
      fsq_id: 'fsq_tokyo_hist_01',
      name: 'Senso-ji Ancient Temple',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 12099, name: 'Temple' }],
      geocodes: { main: { latitude: 35.7148, longitude: 139.7967 } },
      location: { formatted_address: '2-3-1 Asakusa, Taito City, Tokyo 111-0032, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.8,
      price: 1,
    },
    {
      fsq_id: 'fsq_tokyo_hist_02',
      name: 'Meiji Jingu Shrine',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 16032, name: 'Park' }],
      geocodes: { main: { latitude: 35.6764, longitude: 139.6993 } },
      location: { formatted_address: '1-1 Yoyogikamizonocho, Shibuya, Tokyo 151-8557, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.6,
      price: 1,
    },
    {
      fsq_id: 'fsq_tokyo_att_01',
      name: 'Tokyo Skytree Observation Deck',
      categories: [{ id: 16000, name: 'Landmark' }],
      geocodes: { main: { latitude: 35.7101, longitude: 139.8107 } },
      location: { formatted_address: '1-1-2 Oshiage, Sumida City, Tokyo 131-0045, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.5,
      price: 3,
    },
    {
      fsq_id: 'fsq_tokyo_mkt_01',
      name: 'Tsukiji Outer Fish Market',
      categories: [{ id: 17069, name: 'Market' }, { id: 13065, name: 'Restaurant' }],
      geocodes: { main: { latitude: 35.6655, longitude: 139.7707 } },
      location: { formatted_address: '4-16-2 Tsukiji, Chuo City, Tokyo 104-0045, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.4,
      price: 2,
    },
    {
      fsq_id: 'fsq_tokyo_shop_01',
      name: 'Akihabara Electric & Manga Town',
      categories: [{ id: 17000, name: 'Shopping' }, { id: 10000, name: 'Entertainment' }],
      geocodes: { main: { latitude: 35.6984, longitude: 139.7731 } },
      location: { formatted_address: 'Sotokanda, Chiyoda City, Tokyo 101-0021, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.3,
      price: 2,
    },
    {
      fsq_id: 'fsq_tokyo_cafe_01',
      name: 'Fuglen Tokyo Cafe',
      categories: [{ id: 13035, name: 'Coffee Shop' }, { id: 13034, name: 'Café' }],
      geocodes: { main: { latitude: 35.6636, longitude: 139.6917 } },
      location: { formatted_address: '1-16-11 Tomigaya, Shibuya, Tokyo 151-0063, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.3,
      price: 2,
    },
    {
      fsq_id: 'fsq_tokyo_rest_01',
      name: 'Ichiran Ramen Shibuya',
      categories: [{ id: 13065, name: 'Restaurant' }],
      geocodes: { main: { latitude: 35.6617, longitude: 139.7003 } },
      location: { formatted_address: '1-22-7 Jinnan, Shibuya City, Tokyo 150-0041, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.4,
      price: 2,
    },
    {
      fsq_id: 'fsq_tokyo_mus_01',
      name: 'teamLab Planets TOKYO',
      categories: [{ id: 10027, name: 'Museum' }, { id: 10000, name: 'Entertainment' }],
      geocodes: { main: { latitude: 35.6514, longitude: 139.7917 } },
      location: { formatted_address: '6-1-16 Toyosu, Koto City, Tokyo 135-0061, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.7,
      price: 3,
    },
    {
      fsq_id: 'fsq_tokyo_bar_01',
      name: 'Golden Gai Shinjuku Bar Alley',
      categories: [{ id: 13003, name: 'Bar' }, { id: 10039, name: 'Night Club' }],
      geocodes: { main: { latitude: 35.6942, longitude: 139.7047 } },
      location: { formatted_address: 'Kabukicho, Shinjuku City, Tokyo 160-0021, Japan', country: 'JP', locality: 'Tokyo' },
      rating: 9.2,
      price: 2,
    },
  ],
  manali: [
    {
      fsq_id: 'fsq_manali_att_01',
      name: 'Solang Valley Adventure Grounds',
      categories: [{ id: 18000, name: 'Adventure' }, { id: 16032, name: 'Nature' }],
      geocodes: { main: { latitude: 32.3167, longitude: 77.1500 } },
      location: { formatted_address: 'Solang Valley, Burwa, Manali 175131, Himachal Pradesh', country: 'IN', locality: 'Manali' },
      rating: 9.5,
      price: 2,
    },
    {
      fsq_id: 'fsq_manali_hist_01',
      name: 'Hadimba Devi Temple',
      categories: [{ id: 16020, name: 'Historic and Protected Site' }, { id: 12099, name: 'Temple' }],
      geocodes: { main: { latitude: 32.2483, longitude: 77.1800 } },
      location: { formatted_address: 'Hadimba Temple Rd, Old Manali, Manali 175131, Himachal Pradesh', country: 'IN', locality: 'Manali' },
      rating: 9.6,
      price: 1,
    },
    {
      fsq_id: 'fsq_manali_cafe_01',
      name: 'Cafe 1947 Old Manali',
      categories: [{ id: 13034, name: 'Café' }, { id: 13065, name: 'Restaurant' }],
      geocodes: { main: { latitude: 32.2589, longitude: 77.1742 } },
      location: { formatted_address: 'Old Manali Bridge, Manali 175131, Himachal Pradesh', country: 'IN', locality: 'Manali' },
      rating: 9.4,
      price: 2,
    },
    {
      fsq_id: 'fsq_manali_nat_01',
      name: 'Jogini Waterfalls Trek',
      categories: [{ id: 16016, name: 'Nature' }, { id: 18000, name: 'Adventure' }],
      geocodes: { main: { latitude: 32.2689, longitude: 77.1950 } },
      location: { formatted_address: 'Vashisht, Manali 175131, Himachal Pradesh', country: 'IN', locality: 'Manali' },
      rating: 9.5,
      price: 1,
    },
    {
      fsq_id: 'fsq_manali_mkt_01',
      name: 'Mall Road Manali',
      categories: [{ id: 17069, name: 'Market' }, { id: 17000, name: 'Shopping' }],
      geocodes: { main: { latitude: 32.2428, longitude: 77.1892 } },
      location: { formatted_address: 'Mall Rd, Siyal, Manali 175131, Himachal Pradesh', country: 'IN', locality: 'Manali' },
      rating: 9.0,
      price: 2,
    },
    {
      fsq_id: 'fsq_manali_hist_02',
      name: 'Naggar Castle Heritage',
      categories: [{ id: 16007, name: 'Castle' }, { id: 16020, name: 'Historic and Protected Site' }],
      geocodes: { main: { latitude: 32.1381, longitude: 77.1706 } },
      location: { formatted_address: 'Naggar, Kullu Valley, Himachal Pradesh 175130', country: 'IN', locality: 'Manali' },
      rating: 9.4,
      price: 2,
    },
  ],
